...
set(Qt5Quick_VERSION_STRING 5.6.0)
...
if (NOT TARGET Qt5::Quick)
    ...
    set(Qt5Quick_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick_install_prefix}/include/QtQuick/5.6.0"
        "${_qt5Quick_install_prefix}/include/QtQuick/5.6.0/QtQuick"
    )
    ...
    foreach(_module_dep ${_Qt5Quick_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.6.0 ${_Qt5Quick_FIND_VERSION_EXACT}
    ...
    _populate_Quick_target_properties(RELEASE "libQt5Quick.so.5.6.0" "" )
