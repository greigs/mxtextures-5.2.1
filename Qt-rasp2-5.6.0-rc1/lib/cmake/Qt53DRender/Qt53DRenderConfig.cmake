...
set(Qt53DRender_VERSION_STRING 5.6.0)
...
if (NOT TARGET Qt5::3DRender)
    ...
    set(Qt53DRender_PRIVATE_INCLUDE_DIRS
        "${_qt53DRender_install_prefix}/include/Qt3DRender/5.6.0"
        "${_qt53DRender_install_prefix}/include/Qt3DRender/5.6.0/Qt3DRender"
    )
    ...
    set(_Qt53DRender_MODULE_DEPENDENCIES "3DCore;OpenGLExtensions;Gui;Concurrent;Core")
    ...
    foreach(_module_dep ${_Qt53DRender_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.6.0 ${_Qt53DRender_FIND_VERSION_EXACT}
    ...
    set(_Qt53DRender_LIB_DEPENDENCIES "Qt5::3DCore;Qt5::OpenGLExtensions;Qt5::Gui;Qt5::Concurrent;Qt5::Core")
    ...
    _populate_3DRender_target_properties(RELEASE "libQt53DRender.so.5.6.0" "" )
