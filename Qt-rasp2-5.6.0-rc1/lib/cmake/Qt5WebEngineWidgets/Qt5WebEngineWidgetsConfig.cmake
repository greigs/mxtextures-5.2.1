...
set(Qt5WebEngineWidgets_VERSION_STRING 5.6.0)
...
if (NOT TARGET Qt5::WebEngineWidgets)
    ...
    set(Qt5WebEngineWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngineWidgets_install_prefix}/include/QtWebEngineWidgets/5.6.0"
        "${_qt5WebEngineWidgets_install_prefix}/include/QtWebEngineWidgets/5.6.0/QtWebEngineWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5WebEngineWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.6.0 ${_Qt5WebEngineWidgets_FIND_VERSION_EXACT}
    ...
    _populate_WebEngineWidgets_target_properties(RELEASE "libQt5WebEngineWidgets.so.5.6.0" "" )
