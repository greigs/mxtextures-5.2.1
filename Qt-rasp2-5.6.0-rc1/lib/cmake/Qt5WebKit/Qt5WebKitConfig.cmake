...
set(Qt5WebKit_VERSION_STRING 5.6.0)
...
if (NOT TARGET Qt5::WebKit)
    ...
    set(Qt5WebKit_PRIVATE_INCLUDE_DIRS
        "${_qt5WebKit_install_prefix}/include/QtWebKit/5.6.0"
        "${_qt5WebKit_install_prefix}/include/QtWebKit/5.6.0/QtWebKit"
    )
    ...
    foreach(_module_dep ${_Qt5WebKit_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.6.0 ${_Qt5WebKit_FIND_VERSION_EXACT}
    ...
    _populate_WebKit_target_properties(RELEASE "libQt5WebKit.so.5.6.0" "" )
