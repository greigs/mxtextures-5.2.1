...
set(Qt5WebKitWidgets_VERSION_STRING 5.6.0)
...
if (NOT TARGET Qt5::WebKitWidgets)
    ...
    set(Qt5WebKitWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5WebKitWidgets_install_prefix}/include/QtWebKitWidgets/5.6.0"
        "${_qt5WebKitWidgets_install_prefix}/include/QtWebKitWidgets/5.6.0/QtWebKitWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5WebKitWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.6.0 ${_Qt5WebKitWidgets_FIND_VERSION_EXACT}
    ...
    _populate_WebKitWidgets_target_properties(RELEASE "libQt5WebKitWidgets.so.5.6.0" "" )
